...
const Ico = {
  ...
  // Gauge / speedometer — "dashboard". Used by the sidebar's return-to-
  // dashboard button; distinct from `grid` (the projects view-toggle).
  gauge:    (s = 16) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></svg>,
